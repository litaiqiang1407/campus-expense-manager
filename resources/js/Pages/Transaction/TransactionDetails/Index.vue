<template>
    <div>
      ...
      <Form :action="'Save'" @submit="submitForm">
          ...
          <Select :iconSrc="walletIcon" :selectText="wallet_name ? wallet_name : 'Select Wallet'" :items="wallets"
              :getItemLabel="item => item.name" />
      </Form>
      <div class="pl-4">
          <button class="mt-4 mr-1 p-2 bg-primary text-white text-[16px] rounded" @click="editTransaction(transactionId)">
              Edit
          </button>
